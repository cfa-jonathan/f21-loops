...
// 3) Create a for loop that loops through the "characters" string and checks each
//    letter to see if it is a "$" dollar symbol. If it is, store the current index
//    in the "dollarSymbolIndex" variable
//
//    Note: You are not allowed to use the "indexOf" function to get the index


// 4) Inside (3)'s for loop, use a "break" keyword to exit the loop after finding
//    and storing the index. This reduces the amount of time it takes to complete
//    the function


// for...of Loops
// 5) Retrieve ALL of the "p" tag elements out of the DOM and store the collection in
//    a new variable with a unique identifier


// 6) Use a "for...of" loop to iterate through each "p" element retrieved out of
//    the DOM and stored in your variable, and set each background color to "salmon"


// 7) Inside (5)'s "for...of" loop, check to see if each "p" element's text content
...
// 8) Use a "for" loop inside another "for" loop to print out each value in each
